...
mkdir datasets
cd datasets
gdown https://drive.google.com/file/d/1FRDs9V8SXFZRhyqUmMZpTiSTyLXBiCw0/view?usp=drive_link
unzip BDTSD.zip
cd ..
```
...
mkdir output
cd output
gdown https://drive.google.com/file/d/1ogF_v2QdDLPgnsCimXNpQUrv-hXHsl4m/view?usp=drive_link
cd ..
```
